...
You can disable services you don't need to reduce resource usage:
...
All APIs are available through the Kong gateway on port 8186:

- REST: `http://ansible_nas_host_or_ip:8186/rest/v1/`
- Auth: `http://ansible_nas_host_or_ip:8186/auth/v1/`
- Storage: `http://ansible_nas_host_or_ip:8186/storage/v1/`
- Realtime: `http://ansible_nas_host_or_ip:8186/realtime/v1/`

### Database Access

Connect via Supavisor connection pooler:

- Session mode: `postgres://postgres.<tenant_id>:<password>@ansible_nas_host_or_ip:5442/postgres`
- Transaction mode: `postgres://postgres.<tenant_id>:<password>@ansible_nas_host_or_ip:6543/postgres`
